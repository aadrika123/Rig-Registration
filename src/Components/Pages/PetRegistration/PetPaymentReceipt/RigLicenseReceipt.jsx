  ...
  render() {
    ...
    return (
      <>
        ...
        <div
          className="border-2 font-Lato w-[40rem] p-3 mx-auto ml-20 mt-10 border-gray-700 "
          id="printableArea"
        >
              ...
              >
                ...
                <div className="grid grid-cols-3 h-auto ">
                  <div className="w-20 h-20 rounded-full">
                    <img
                      src={this.props?.licenceData?.ulbDetails?.ulb_logo}
                      alt="ULB logo"
                ...
                <div className="mx-auto text-center">
                  <p className=" py-1 my-1">
                    {" "}
                    (This Certificate relates to Under Jharkhand Municipal Act
                    of 2011){" "}
                  </p>
                </div>
                <div className="w-full px-1.5 mt-4 ">
                  ...
                  <div className="grid grid-cols-3 h-auto capitalize">
                    ...
                    <div className=" mx-auto mt-1"></div>
                  </div>
                ...
                <div className="grid grid-cols-1 w-full mt-4 text-[13px]">
                  <div>
                    ...
                    as mentioned in Jharkhand Municipal Act 2011 in the regime
                    of {this.props?.licenceData?.ulb_name}. The validity of this
                    licence is for ONE YEARS along with following terms and
                    conditions:-
                  </div>
                </div>
                      ...
                      <div className="ml-4">
                        <div className="mt-4 mb-4 px-4 text-red-700">
                          <p>
                            ...
                            <span className="lowercase">
                              {
                                this.props?.licenceData?.ulbDetails
                                  ?.ulb_parent_website
                              }
                            </span>
                          </p>
                          ...
                          <p className="text-xs whitespace-nowrap">
                            Note: This is a computer generated License and it
