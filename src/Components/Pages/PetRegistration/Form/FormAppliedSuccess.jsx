  ...
  return (
    <div className='space-y-2'>
      ...
      <div className='flex justify-center gap-x-5'>
        ...
        <button onClick={() => navigate(`/rig-payment-offline/${props?.data?.id}`)} className='bg-indigo-500 px-2 py-1 rounded shadow text-white hover:bg-indigo-700'>Make Payment</button>
      </div>
    </div>
  )
}
