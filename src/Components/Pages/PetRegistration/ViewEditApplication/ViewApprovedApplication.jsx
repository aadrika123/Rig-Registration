...
const ViewApprovedApplication = () => {
  ...
  const { api_PetApproveViewApplication, header, api_RigUploadedDoc } =
    PetRegAPIList();
  {
  ...
  return (
    <>
      <div className="flex justify-between">
        ...
        {applicationFullData?.isRenewal == true ? (
      ...
      {applicationFullData?.transactionDetails?.payment_mode == "CASH" &&
        applicationFullData?.payment_status == 1 &&
        applicationFullData?.registrationStatus == 1 && (
            ...
            <div className="overflow-y-auto">
                        ...
                        <>
                          {docDetails?.map((items, i) => (
                            <tr className="bg-white shadow-lg border-b border-gray-200">
                              ...
                              <td className="px-2 py-2 text-sm text-left text-[#37517e]">
                                {nullToNA(items?.remarks)}
                              </td>
                              <td className="px-2 py-2 text-sm text-left text-[#37517e]">
                                {items?.doc_path?.split(".").pop() == "pdf" ? (
                                  <img
                              ...
                              <td className="px-2 py-2 text-sm text-left text-[#37517e]">
                                {items?.doc_path ? (
                                  ...
                                  <button
                                    disabled
                                    className="bg-indigo-200 text-white px-2 py-1 rounded"
                                  >
                                    View
                                  </button>
                                )}
              ...
              <div className="bg-white shadow-xl p-4 border border-gray-200">
                ...
                {loader ? (
                  ...
                  applicationFullData?.registrationStatus == 1 &&
                  localStorageItem?.roles[0] != "EXECUTIVE OFFICER" ? (
