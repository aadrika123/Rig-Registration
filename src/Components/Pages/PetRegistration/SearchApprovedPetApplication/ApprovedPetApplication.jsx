...
// Hook for  navigation 
    ...
    // Formik hook for handling the search form
    ...
    // Effect hook to set the request body when the component mounts
    useEffect(() => {
        setRequestBody({
            "filterBy": values.searchBy,
            "parameter": values.searchText,
            ...
            <div className="">
                <div className="border bg-white rounded p-3 pb-8">
                    ...
                    <>
                        ...
                        <div>
                            {/* <p className='border-b-2 mb-5'></p> */}
                            {requestBody != null && <ListTableConnect
                                api={api_ApprovedPetApplication} // sending api
...
export default ApprovedPetApplication
