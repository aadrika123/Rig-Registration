...
// 👉 Define the functional component SearchRejectPetApplication 👈
const SearchRejectPetApplication = (props) => {
    // State variables
    const [searchingData, setSearchingData] = useState(false)
    const [data, setData] = useState(false)

    // 👉 API endpoints for fetching Rejected Pet Application details 👈
    const { api_searchRejectedPetApplication } = PetRegAPIList()
                    ...
                    <>
                        ...
                        <div>
                            {requestBody != null && <ListTableConnect
                                api={api_searchRejectedPetApplication} // sending api
...
export default SearchRejectPetApplication