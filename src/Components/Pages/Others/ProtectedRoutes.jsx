    ...
    <>
      ...
      <div className="relative flex justify-center items-center h-[100vh] w-full ">
        <div className="flex flex-row flex-wrap w-full md:w-[100%] h-full md:h-[100%] bg-[#eff2f7] drop-shadow-[0_15px_15px_rgba(0,0,0,0.25)] overflow-clip ">
          ...
          <div
            className={
              "md:flex md:relative absolute top-[3.4rem] md:top-0 h-full"
            }
            style={{ zIndex: 999 }}
          >
          ...
          <div
            className="flex-1 h-full w-[60%] relative overflow-auto border md:border-none"
            onClick={() => window.innerWidth <= 763 && settoggleBar(false)}
          >
