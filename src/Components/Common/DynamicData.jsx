export default function ulb_data() {
  ...
  const ulb = {
    akola: {
      ...
      state: "Maharashtra",
      address:
        "PX5X+356 Akola Municipal Corporation Headquarters, inside Municipal corporation, New Radhakisan Plots, Akola, Maharashtra 444002",
      ...
      brand_logo:
        "https://res.cloudinary.com/djkewhhqs/image/upload/v1709034287/JUIDCO_IMAGE/ULB%20Logo/rmc_Logo_nqr7xn.jpg",
      state_logo: "https://jharkhandegovernance.com/Uploads/Icon/akola.png",
      state_logo:
        "https://jharkhandegovernance.com/egov-backend/Uploads/Icon/jharkhand.png",
